...
export const CORE_MODULES: WorkbenchModuleDescriptor[] = [
  ...
  },
  {
    ...
    core: true,
    resourceTier: "required",
    tools: ["workspace_read", "workspace_search", "workspace_propose_patch"],
  },
  {
    id: "core.governance",
    version: 3,
    label: "Governance and run ledger",
    description: "Per-call approvals, provenance, recovery, cancellation, and event history.",
    core: true,
    resourceTier: "required",
...
export const OPTIONAL_MODULES: WorkbenchModuleDescriptor[] = [
  {
    ...
    version: 1,
    label: "PubMed",
    description: "NCBI literature metadata with per-call network approval.",
    core: false,
    resourceTier: "light",

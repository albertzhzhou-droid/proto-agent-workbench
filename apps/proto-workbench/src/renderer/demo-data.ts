...
export const DEMO_MODELS: ModelDescriptor[] = [
  {
    id: "gpt-oss-20b",
    name: "GPT-OSS 20B",
    path: "lmstudio:openai/gpt-oss-20b@mxfp4",
    files: [],
    sizeBytes: 12.11 * GIB,
    ...
    provider: "lmstudio",
    providerModelId: "openai/gpt-oss-20b@mxfp4",
    publisher: "openai",
    modelKind: "llm",
    format: "gguf",
    loadedInstances: [{ id: "gpt-oss-20b-workbench", contextLength: 131072, evalBatchSize: 512, flashAttention: true, offloadKvCacheToGpu: true }],
    workbenchInstance: { id: "gpt-oss-20b-workbench", ownedByWorkbench: true },
  },
  {
    id: "qwythos-9b",
    name: "Qwythos 9B Mythos",
    path: "lmstudio:empero-ai/qwythos-9b@q4_k_m",
    files: [],
    sizeBytes: 6.55 * GIB,
    architecture: "qwen35",
    quantization: "Q4_K_M",
    ...
    metadataSource: "lmstudio",
    provider: "lmstudio",
    providerModelId: "empero-ai/qwythos-9b@q4_k_m",
    publisher: "empero-ai",
    modelKind: "llm",
    format: "gguf",
    loadedInstances: [{ id: "qwythos-external", contextLength: 32768, evalBatchSize: 512, flashAttention: true, offloadKvCacheToGpu: true }],
  },
  {
    id: "qwen-agentworld",
    name: "Qwen AgentWorld 35B A3B",
    path: "lmstudio:unsloth/qwen-agentworld-35b-a3b@q4_k_s",
    files: [],
    sizeBytes: 20.89 * GIB,
    ...
    metadataSource: "lmstudio",
    provider: "lmstudio",
    providerModelId: "unsloth/qwen-agentworld-35b-a3b@q4_k_s",
    publisher: "unsloth",
    modelKind: "llm",
    format: "gguf",
    loadedInstances: [],
  },
  {
    ...
    path: "lmstudio:google/gemma-4-26b-a4b@q4_k_m",
    files: [],
    sizeBytes: 17.99 * GIB,
    architecture: "gemma4",
    quantization: "Q4_K_M",
    ...
    metadataSource: "lmstudio",
    provider: "lmstudio",
    providerModelId: "google/gemma-4-26b-a4b@q4_k_m",
    publisher: "google",
    modelKind: "llm",
    format: "gguf",
    loadedInstances: [],

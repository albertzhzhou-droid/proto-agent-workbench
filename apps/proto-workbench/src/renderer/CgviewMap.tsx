  ...
  useEffect(() => {
    ...
    try {
      viewer = new Viewer(`#${containerId}`, {
        ...
        ruler: { visible: showIndex && construct.length >= 200, color: "#667970", font: "Proto Sans Text, plain, 9", tickCount: rulerTickCount(width, height, mapFormat), rulerPadding: 6 },
        annotation: {
          visible: showAnnotations && labelDensity !== "hidden",
          font: "Proto Sans Text, plain, 9",
          fontColor: "#26332f",

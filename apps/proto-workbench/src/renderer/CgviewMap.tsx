  ...
  useEffect(() => {
    ...
    try {
      viewer = new Viewer(`#${containerId}`, {
        ...
        settings: { backgroundColor: "#fdfcf9", showShading: false, arrowHeadLength: 0.22 },
        backbone: { color: "#63736f", thickness: 4 },
        ruler: { visible: showIndex && construct.length >= 200, color: "#667970", font: "Anthropic Sans Text, plain, 9", tickCount: rulerTickCount(width, height, mapFormat), rulerPadding: 6 },
        annotation: {
          visible: showAnnotations && labelDensity !== "hidden",
          font: "Anthropic Sans Text, plain, 9",
          fontColor: "#26332f",
    ...
    try {
      ...
      viewer.addCaptions([{
        ...
        position: "top-left",
        anchor: "top-left",
        font: "Anthropic Sans Text, bold, 9",
        fontColor: "#33443f",
        textAlignment: "left",
        ...
        anchor: "bottom-left",
        font: "Anthropic Sans Text, plain, 7",
        fontColor: "#6b5541",
        textAlignment: "left",

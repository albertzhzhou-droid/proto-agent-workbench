...
/**
 * Permanently fail closed. Model-pool ownership and residency belong to LM
 * Studio, so this former independent-runtime verifier is not a valid product
 * or release entry point.
 */
